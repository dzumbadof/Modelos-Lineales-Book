...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\textsc{\Large CA-0404 Modelos Lineales}\\[0.5cm] % Major heading such as course name
	
\textsc{\large Anteproyecto de investigación}\\[0.5cm] % Minor heading such as course title
...
% 		 Luis Alberto Barboza Chinchilla
% 	\end{flushright}
% 	\end{minipage}
	
	% If you don't want a supervisor, uncomment the two lines below and comment the code above
		{\large\textit{Profesor}}\\
	Luis Barboza Chinchilla\\[0.5cm]
	
	{\large\textit{Autores}}\\
	David Zumbado Fernández \\ % Your name
