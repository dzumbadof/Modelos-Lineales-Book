...
## Objetivos 
**Objetivo general: ** Hacer un pronóstico de la cantidad de defunciones totales de Costa Rica para una ventana de tiempo de dos años (2019 y 2020). 

**Objetivo específico 1: ** Ajustar un modelo ARIMA a los datos con el chequeo correspondiebte de los supuestos y bondad de ajuste

**Objetivo específico 2: ** Ajustar y seleccionar un modelo utilizando dlm polinomial con el chequeo correspondiente de los supuestos y bondad de ajuste

**Objetivo específico 3: ** Comparar los pronósticos obtenidos con cada modelo
...
![UVE Heurística](Images/UVE%20Flecha.png){fig-align="center" width="600"}
